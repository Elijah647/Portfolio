    ...
    <>
      <div className="text-center py-10 sm:min-h-screen lg:min-h-0 lg:pb-24">
        ...
        <div className="flex flex-col px-2 lg:flex-row-reverse items-center justify-center gap-10 lg:gap-24">
          ...
          {/* Contact Form */}
          <form
            name="contact-form" // Required for Netlify to detect the form
            method="POST" // POST method for submitting the form
            data-netlify="true" // Required to enable Netlify form handling
