    ...
    >
      ...
      <div className="relative z-10 md:w-1/2 text-center md:text-start flex flex-col items-center md:items-start p-5 md:p-1">
        ...
        <div className="flex space-x-4 mb-4 opacity-0 animate-fadeInUp delay-1100">
          <button
            onClick={handleClick}
            className="text-md bg-gray-900 text-white p-2 w-28 md:w-36 md:text-lg rounded-full hover:bg-neutral-500 transition duration-300 transform hover:scale-105"
          >
            Resume
          </button>
          <a href="#contact">
            <button className="text-md bg-gray-200 text-black w-28 p-2 md:w-36 md:text-lg rounded-full hover:bg-neutral-400 transition duration-300 transform hover:scale-105">
              Contact info
            </button>
          </a>
        </div>
