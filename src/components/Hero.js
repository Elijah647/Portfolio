  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 md:w-1/2 text-center md:text-start flex flex-col items-center md:items-start p-5 md:p-1">
        ...
        <p className="text-2xl md:text-4xl font-semibold text-yellow-500 mb-8 animate-scaleUp delay-600">
          &lt; Web Developer /&gt;
        </p>

        <p className="text-lg md:text-2xl text-white px-10 lg:px-0 font-normal mb-16 animate-fadeInUp delay-900 leading-snug tracking-wide">
